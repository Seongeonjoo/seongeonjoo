...
import {HorizontalInterval} from "shared/components/LayoutComponents";
import DataTable from "shared/components/CustomDataGride";

const axiosTest = async (data: { parentId: string, req: EquipmentClassifyRequest[] }) => {
  return EquipmentCategoryService.setTest(data.parentId, data.req)
}
